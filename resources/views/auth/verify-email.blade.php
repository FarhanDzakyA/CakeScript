...
<div class="flex flex-col items-center justify-start">
    ...
    <p class="text-center mb-4">A verification email has been sent to your email address. Please check your email and click the link provided in the email to complete your account registration.</p>
    <p class="text-center mb-4">If you don't receive an email within the next 5 minutes, use the button below to resend verification email.</p>
