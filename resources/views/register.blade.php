            ...
            <form action="{{ url('/register') }}" method="post" class="w-full mb-6">
                ...
                <div class="mb-3">
                    ...
                    <div class="relative mt-2 flex items-center">
                        ...
                        <input type="text" id="full_name" name="nama_pelanggan" class="w-full bg-transparent border-2 border-gray-600 text-gray-600 font-sans text-base rounded-xl focus:ring-2 focus:ring-leaf focus:border-leaf focus:outline-none ps-10 p-2.5" placeholder="Enter the name as it is on the ID card" value="{{ old('nama_pelanggan') }}">
                    </div>
