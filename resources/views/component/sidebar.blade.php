<div class="w-64 bg-leaf text-white fixed top-0 bottom-0 flex flex-col">
    <div class="bg-brightleaf py-6 px-2 text-center text-xl font-bold">
        <img src="{{ asset('img/BrandIcon.png') }}" alt="" class="w-full bg-white mix-blend-lighten mb-1.5">
        Admin Panel
    </div>
    <nav class="flex-grow">
        ...
        <a href="#" class="flex items-center justify-start py-3 px-6 hover:bg-darkleaf hover:text-cyan-500 {{ Request::is('') ? 'text-cyan-500' : '' }}">
